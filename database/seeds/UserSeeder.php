...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Illuminate\Support\Facades\DB::table('zys_model_has_permissions')->truncate();
        \Illuminate\Support\Facades\DB::table('zys_model_has_roles')->truncate();
        \Illuminate\Support\Facades\DB::table('zys_role_has_permissions')->truncate();
        \Illuminate\Support\Facades\DB::table('zys_users')->truncate();
        \Illuminate\Support\Facades\DB::table('zys_roles')->truncate();
        \Illuminate\Support\Facades\DB::table('zys_permissions')->truncate();
