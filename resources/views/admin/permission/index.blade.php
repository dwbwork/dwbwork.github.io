        ...
        <script>
            layui.use(['layer', 'table', 'admin','form', 'treetable'], function () {
                ...
                var dataTable = function () {
                    treetable.render({
                        ...
                        cols: [[ //表头
                            ...
                            , {fixed: 'right', width: 240, align: 'center', toolbar: '#options'}
                        ]]
                    });
                }
                ...
                $('#btnAddRole').click(function () {
                    showEditModel('新增菜单',"{{route('admin.permission.create')}}");
                });
                ...
                table.on('tool(dataTable)', function (obj) { //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if (layEvent === 'del') {
                        ...
                        showEditModel('编辑权限','/admin/permission/' + data.id + '/edit');
                       // location.href = '/admin/permission/' + data.id + '/edit';
                    }else if (layEvent === 'add') {
                        showEditModel('新增权限','/admin/permission/create?pid=' + data.id);
                       // location.href = '/admin/permission/' + data.id + '/edit';
                    }
                });
            })
