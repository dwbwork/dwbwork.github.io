    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="options">
                <div class="layui-btn-group">
                    @can('system.icon.edit')
                        <a class="layui-btn layui-btn-sm" lay-event="edit">编辑</a>
                    @endcan
                    @can('system.icon.destroy')
            ...
            layui.use(['layer','table','admin','form'],function () {
                ...
                var dataTable =
                    table.render({
                        ...
                        ,cols: [[ //表头
                            ...
                            ,{field: 'name', title: '图标名',width:180}
                ...
                table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if(layEvent === 'del'){
                        ...
                        showEditModel('编辑'+data.title,'/admin/icon/'+data.id+'/edit');
                ...
                $('#btnAddRole').click(function () {
                    showEditModel('新增分类',"{{route('admin.icon.create')}}");
                });
// 显示表单弹窗
