    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="options">
                <div class="layui-btn-group">
                    @can('message.journ_cate.edit')
                        <a class="layui-btn layui-btn-sm" lay-event="edit">编辑</a>
                    @endcan
                    @can('message.journ_cate.destroy')
        ...
        <script>
           layui.use(['layer', 'table', 'form','admin', 'treetable'], function () {
                ...
                var dataTable = function () {
                  treetable.render({
                      ...
                      ,height: 600,        // treetable新增参数
                        elem: '#dataTable',
                        url: "{{ route('admin.journ_cate.data') }}",
                        cols: [[ //表头
               ...
               $('#btnAddRole').click(function () {
                   showEditModel('新增分类',"{{route('admin.journ_cate.create')}}");
               });
                ...
                table.on('tool(dataTable)', function (obj) { //注：tool是工具条事件名，dataTable是table原始容器的属性 lay-filter="对应的值"
                    ...
                    if (layEvent === 'del') {
                        layer.confirm('确认删除吗？', function (index) {
                            layer.close(index)
                            var load = layer.load();
                            $.post("{{ route('admin.journ_cate.destroy') }}", {
                                _method: 'delete',
                                ids: [data.id]
                            }, function (res) {
                                layer.close(load);
                        ...
                        showEditModel('编辑分类','/admin/journ_cate/' + data.id + '/edit');
