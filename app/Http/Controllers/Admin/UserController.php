...
{ 
    ...
    {
        $company = Company::get();
        return View::make('admin.user.create')->with(['company'=>$company]);
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('admin.user.edit',compact('user','company'));
    }
                ...
                foreach ($p1->childs as $p2){
                    ...
                    if ($p2->childs->isNotEmpty()){
                        foreach ($p2->childs as $p3){
                            ...
                            if ($p3->childs->isNotEmpty()){
                                foreach ($p3->childs as $p4){
                                    $p4->own = $user->hasPermissionTo($p4->id) ? 'checked' : '' ;
                                }
                            }
                        }
                    }
